...
import 'dart:convert'; // Import essentiel pour sérialiser le lieu en texte JSON[cite: 8]
...
class _LeCairePageState extends State<LeCairePage> {
  ...
  // Clé globale identique partagée avec home.dart (version française)[cite: 8]
  ...
  // Alterne l'état favori et l'enregistre en JSON de manière synchrone pour le rafraîchissement visuel[cite: 8]
  ...
  Widget _buildDesignCard(Map<String, dynamic> item, Color color) {
    ...
    // Vérifier si le lieu est présent dans la liste JSON globale[cite: 8]
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => _toggleFavoriLieu(item), // Passe le Map complet de données au clic[cite: 8]
                    ),
                  ],
                ),
