...
import 'dart:convert'; // Essential import for serializing the place into JSON text
  ...
  static const List<Map<String, dynamic>> _cairoData = [
    {
      ...
      "sub_folder": "Cairo", // Ajouté pour la cohérence avec le système de tri
  ...
  Future<void> _toggleFavoritePlace(Map<String, dynamic> item) async {
    ...
    setState(() {
      ...
      if (exists) {
        ...
        _favoritePlacesJson.add(jsonEncode(item));
      }
    });
