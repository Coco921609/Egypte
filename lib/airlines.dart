    ...
    return Scaffold(
      ...
      body: ScrollConfiguration(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            // --- BARRE DE NAVIGATION (Disparaît au scroll) ---
            SliverAppBar(
              pinned: false, // Disparaît au scroll
              floating: true, // Réapparaît dès qu'on remonte
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  item["destination"], // destination en minuscules
            ...
            _buildAirlineList("vols directs", item["direct"], true), // titre minuscules
            const SizedBox(height: 25),
            _buildAirlineList("avec escale", item["escale"], false), // titre minuscules
          ],
        ),
      ),
    );
  ...
  Widget _buildAirlineList(String title, List<dynamic> airlines, bool isDirect) {
    return Column(
      ...
      children: [
        ...
        airlines.isEmpty
            ? Text(
            "aucun vol direct", // texte minuscules
            style: GoogleFonts.montserrat(
          ...
          children: airlines.map((name) => Container(
            ...
            child: Text(
                name, // noms airlines en minuscules
                style: GoogleFonts.montserrat(
