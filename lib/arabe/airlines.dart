...
class _AirlinesPageState extends State<AirlinesPage> {
  ...
  final List<Map<String, dynamic>> data = [
    {
      "destination": "القاهرة",
      "direct": ["الخطوط الفرنسية", "مصر للطيران", "ترانسافيا", "فيولينج"],
      "escale": ["الملكية الأردنية", "السعودية", "طيران الإمارات", "القطرية", "لوفتهانزا", "السويسرية", "إيجيان", "الخطوط التركية", "إيتا الإيطالية", "تاروم", "لوت البولندية", "البريطانية", "الاتحاد", "طيران الخليج", "الملكية المغربية", "طيران عمان", "طيران الجزيرة", "النمساوية", "ويز إير"]
    },
    {
      "destination": "شرم الشيخ",
      "direct": ["إيزي جيت", "إير كايرو"],
      "escale": ["بيجاسوس", "الخطوط التركية", "ويز إير", "السويسرية", "مصر للطيران", "الاتحاد"]
    },
    {
      "destination": "الغردقة",
      "direct": ["ترانسافيا فرنسا", "إيزي جيت"],
      "escale": ["الخطوط التركية", "بيجاسوس", "مصر للطيران", "ويز إير", "السويسرية", "كوندور", "يورو وينجز"]
    },
    {
      "destination": "الإسكندرية",
      "direct": [],
      "escale": ["الخطوط التركية", "بيجاسوس"]
    },
  ];
                ...
                leading: Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      // تم استخدام arrow_back في بيئة RTL ليعطي سهم يشير لليمين
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildAirlineList("رحلات مباشرة", item["direct"], true),
            const SizedBox(height: 25),
            _buildAirlineList("رحلات مع توقف", item["escale"], false),
          ],
        ),
      ),
    );
